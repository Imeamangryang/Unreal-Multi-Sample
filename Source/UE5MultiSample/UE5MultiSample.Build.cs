...
public class UE5MultiSample : ModuleRules
{
	public UE5MultiSample(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = PCHUsageMode.UseExplicitOrSharedPCHs;

		PublicIncludePaths.AddRange(new string[] { "UE5MultiSample" });
